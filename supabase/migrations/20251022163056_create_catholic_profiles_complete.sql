/*
  # Perfis Católicos - Sistema Completo
  ...
  1. Nova Tabela: `profiles`
    ...
    - `civil_status` (text, estado civil: solteiro, casado, namorando, religioso, seminarista, diácono, padre)
    ...
    - `quote_author` (text, autor da frase)
    - `bible_passage` (text, passagem bíblica)
    - `sacraments` (text[], sacramentos recebidos)
  ...
  3. Funcionalidades
    ...
    - Estado civil com prefixo automático para padres
...
CREATE TABLE IF NOT EXISTS profiles (
  ...
  sacraments text[] DEFAULT ARRAY[]::text[],
...
CREATE INDEX IF NOT EXISTS profiles_sacraments_idx ON profiles USING GIN(sacraments);
