  ...
  public: {
    Tables: {
      ...
      escala_participantes: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["pessoa_id"]
            isOneToOne: false
            referencedRelation: "estatisticas_mensais"
      ...
      escalas: {
        ...
        Relationships: [
          {
            foreignKeyName: "escalas_comunidade_id_fkey"
      ...
      horarios: {
        ...
        Relationships: [
          {
            foreignKeyName: "horarios_comunidade_id_fkey"
            columns: ["comunidade_id"]
            isOneToOne: false
            referencedRelation: "comunidades"
            referencedColumns: ["id"]
      ...
      pessoas: {
        Row: {
          ...
          created_at: string | null
          funcao: Database["public"]["Enums"]["funcao_type"]
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "pessoas_comunidade_id_fkey"
            columns: ["comunidade_id"]
            isOneToOne: false
            referencedRelation: "comunidades"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pessoas_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      estatisticas_mensais: {
        Row: {
          ...
          funcao: Database["public"]["Enums"]["funcao_type"] | null
          mes: string | null
    ...
    Enums: {
      funcao_type: "acolito" | "coroinha" | "cerimoniario"
    }
    CompositeTypes: {
      [_ in never]: never
    }
